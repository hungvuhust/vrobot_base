 ...
 bool OdometryVrobot::update(double left_pos, double right_pos, const rclcpp::Time & time)
 {
 ...
 bool OdometryVrobot::updateFromVelocity(double left_vel, double right_vel, const rclcpp::Time & time)
 {
   const double dt = time.seconds() - timestamp_.seconds();
   if (dt < 0.001)
   {
 ...
 void OdometryVrobot::updateOpenLoop(double linear, double angular, const rclcpp::Time & time)
 {
 ...
 void OdometryVrobot::setWheelParams(
 ...
 void OdometryVrobot::setVelocityRollingWindowSize(size_t velocity_rolling_window_size)
 {
   velocity_rolling_window_size_ = velocity_rolling_window_size;
