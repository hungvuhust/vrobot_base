...
#ifndef VROBOT_BASE__SRV__DETAIL__SET_PID__FUNCTIONS_H_
#define VROBOT_BASE__SRV__DETAIL__SET_PID__FUNCTIONS_H_
...
#include "vrobot_base/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_vrobot_base
bool
 ...
 * calls
 * vrobot_base__srv__SetPID_Request__init().
...
/**
 * It calls
 * vrobot_base__srv__SetPID_Request__fini()
 ...
 * vrobot_base__srv__SetPID_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vrobot_base__srv__SetPID_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vrobot_base__srv__SetPID_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vrobot_base
...
/**
 * It calls
 * vrobot_base__srv__SetPID_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vrobot_base
...
/**
 * It allocates the memory for the array and calls
 * vrobot_base__srv__SetPID_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vrobot_base
...
/**
 * It calls
 * vrobot_base__srv__SetPID_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VROBOT_BASE__SRV__DETAIL__SET_PID__FUNCTIONS_H_
